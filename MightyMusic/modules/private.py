...
from MightyMusic.config import (
    ASSISTANT_NAME,
    BOT_USERNAME,
    OWNER_USERNAME,
    PROJECT_NAME,
...
def map(pos):
    if pos == 1:
        ...
        button = [
            ...
            [
                InlineKeyboardButton(
                    text="📮 Channel", url=f"https://t.me/{SUPPORT_CHANNEL}"
                ),
                InlineKeyboardButton(
                    text="🏷 Group", url=f"https://t.me/{SUPPORT_GROUP}"
                ),
            ],
            [
                InlineKeyboardButton(
                    text="💡 Owner Bot", url=f"https://t.me/{OWNER_USERNAME}"
                ),
                InlineKeyboardButton(
                    text="✏️ Owner Project", url=f"https://t.me/ZendYNS"
                ),
            ],
